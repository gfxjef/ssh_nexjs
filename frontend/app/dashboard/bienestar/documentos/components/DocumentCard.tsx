...
interface DocumentCardProps {
  ...
  // onEdit y onDelete removidos - Esta sección es solo para visualización
  showActions?: boolean;
        ...
        <div className="flex items-center justify-between">
          ...
          {showActions && (
            <div className="flex items-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              ...
              {/* Opciones de administración removidas - Solo visualización y descarga para usuarios */}
            </div>
          )}
        </div>
      </div>
        ...
        {showActions && (
          <div className="space-y-2">
            ...
            <div className="flex space-x-2">
              ...
              {/* Opciones administrativas removidas - Solo ver/descargar para usuarios normales */}
            </div>
          </div>
        )}
      </div>
