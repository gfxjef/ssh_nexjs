...
import { useNotifications } from '../../app/dashboard/bienestar/context/NotificationsContext';
import { Notification } from '../../lib/bienestar/types';

/**
 * Componente para mostrar un toast de notificación
 */
const NotificationToast = ({ notification, onClose }: { notification: Notification, onClose: () => void }) => {
  ...
  return (
    <div className={`flex items-center p-4 mb-4 border-l-4 rounded-lg shadow-md ${getStyles()}`}>
